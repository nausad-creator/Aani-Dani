                            ...
                            <div class="table-responsive">
                              ...
                              <tbody>
                                <tr>
                                  ...
                                  <td class="align-middle"><div class="form-group mb-0 detailBtn"><ngx-skeleton-loader count="1" [theme]="{ height: '37px', 'margin-bottom': '0px', width: '60%', 'border-radius': '10px' }"></ngx-skeleton-loader></div></td>
