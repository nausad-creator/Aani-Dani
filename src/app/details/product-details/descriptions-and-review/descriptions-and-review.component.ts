...
<div class="reviewSection" [@fadeIn]>
	<ul class="nav nav-tabs" id="myTab" role="tablist">
		<li class="nav-item">
			<a class="nav-link active" id="home-tab" data-toggle="tab" href="#Discription" role="tab"
				aria-controls="home" aria-selected="true">{{'description' | translate}}</a>
		</li>
		<li class="nav-item">
			<a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab"
				aria-controls="profile" aria-selected="false">{{'reviews' | translate}}(6)</a>
		</li>
		<li class="nav-item">
			<a class="nav-link" id="calori-tab" data-toggle="tab" href="#calori" role="tab"
				aria-controls="calori" aria-selected="false">{{'calories' | translate}}</a>
		</li>
	</ul>
			...
			<div class="write_review" *ngIf="isLoggedID">
				<form action="#" method="post" id="commentform" class="comment-form">
					...
					<div class="selectReviw form-group">
						<label for="comment">You're reviewing: Duis sodales tortor tortor
							Culturele . How do you rate this product? *</label>
						<div class="radioGRP">
							<div class="form-check-inline">
								<label class="form-check-label">
									<input type="radio" class="form-check-input"
										name="optradio">
									<div class="ratings"><i class="fas fa-star"></i>
									</div>
								</label>
							</div>
							<div class="form-check-inline">
					...
					<div class="pt-3 pb-3">
						<a href="javascript:voil(0)" class="addcart-btn shopingcart-tbtn btn">
							Submit Review</a>
					</div>
				</form>
			</div>
