...
@Component({
	...
	<div class="AddressSidebar">
		<div class="Sidebar-content">
			...
			<div id="mapModal" style="height:250px;"></div>
			<form class="text-left form-addree" (ngSubmit)="onClickAdd(addForm.getRawValue())" [formGroup]="addForm">	
				<div class="typeAddress">
					<div class="row" *ngIf="address_Type.length > 0">
						<div class="col-4" *ngFor="let item of address_Type"><a (click)="addForm.get('addressType').patchValue(item.type); addForm.get('addressTitle').patchValue(item.type)" [ngClass]="{'selected': item.type===addForm.get('addressType').value}" class="cursr" name="addressType"><i class="icofont-home"></i> {{item.type}}</a></div>
					</div>		
				</div>	
				...
				<input type="text" id="autoGoogless" formControlName="addressBlockNo" ngx-google-places-autocomplete
                    		...
                    		<small class="text-danger small" *ngIf="addForm.controls['addressBlockNo'].hasError('required')">Please enter Address.</small>
				</div>
				<div class="form-group">
				<input type="text" formControlName="addressBuildingName" id="House" class="form-control bg-white" placeholder="House No, Flat No">
                    		<small class="text-danger small" *ngIf="addForm.controls['addressBuildingName'].hasError('required')">Please enter House No, Flat No.</small>
				</div>
				<div class="form-group">
				<input type="text" formControlName="addressLandmark" id="Landmark" class="form-control bg-white" placeholder="Landmark">
                    		<small class="text-danger small" *ngIf="addForm.controls['addressLandmark'].hasError('required')">Please enter Landmark.</small>
				</div>
				<div class="form-group">
				<input type="text" maxlength="10" id="Mobile" formControlName="addressMobile" class="form-control bg-white" placeholder="Mobile no">
                    		<small class="text-danger small" *ngIf="addForm.controls['addressMobile'].hasError('required')">Please enter mobile.</small>
				<small class="text-danger" *ngIf="addForm.controls['addressMobile'].hasError('pattern') && (addForm.controls['addressMobile'].dirty || addForm.controls['addressMobile'].touched)">Please enter valid number.</small>
				</div>
				<div class="pt-3">
                    		<small class="text-danger text-center small" *ngIf="addForm.controls['addressType'].hasError('required')">Please select Address Type.</small>
