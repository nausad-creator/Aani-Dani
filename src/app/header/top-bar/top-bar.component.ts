    ...
    <div class="container">
      <div class="row align-items-center">
	      <div class="left-siteinfo col-md-6 mr-auto d-flex align-items-center">
		  	<div class="logo"> <a href="index.html"><img src="assets/images/logo.png" alt="AaniDani" class="img-fluid"></a>
		  	</div> 
			<div>
	      ...
	      <div class="right-links col-md-6 d-flex spcial_lins_top justify-content-end">	  	
			...
			<div class="cart-topbtn d-flex">
				<a href="#" class="btn user-cart-btrn"><i class="fas fa-shopping-basket"></i>  <span class="counter-addon">1</span></a>
