                ...
                <div class="category_slider card">
                    ...
                    <div class="orderDetailSection" *ngIf="orders.length > 0">
                        <div class="orderDetailList" *ngFor="let order of orders">
                            ...
                            <div class="bodyOrder form-row m-0 align-items-center" *ngFor="let product of order.orderdetails; let i=index;">
                                <div class="col-md-2 col-4">
            						...
            						[errorImage]="'assets/images/error_not_found.png'" [alt]="product.productName" [title]="product.productName">
                                    </div>
                                </div>	
                                ...
                                <div class="col-md-5 text-md-right" *ngIf="i===0">
                                    <p class="mb-0" *ngIf="order.orderDeliveryDate">Delivery Expected by {{order.orderDeliveryDate | date: 'mediumDate'}}</p>
