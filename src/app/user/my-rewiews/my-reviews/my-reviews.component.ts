	...
	<div class="orderDetailList ml-0 mr-0">
		<div class="form-row m-0 p-3">
			...
			<div class="col-md-6 text-md-right mt-2 mt-md-0">
				<p class="mb-0 small">{{'order' | translate}} # 403-6007027-2138715</p>
			</div>
		</div>
		<div class="bodyOrder form-row m-0 pt-0">
			<div class="col-md-8">
				...
				<p class="mb-0 qty">I always get bargained prices, wich are amazing. You can really save
					a lot of money as I do.</p>
			</div>
			<div class="col-md-4 text-md-right">
				<div class="linksOrde">
					<a class="mr-3" href="#">{{'edit' | translate}}</a>
					<a href="#" class="text-danger">{{'delete' | translate}}</a>
				</div>
			</div>
		</div>
	</div>
